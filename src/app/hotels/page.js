        ...
        <div className='dashboard_wrapper'>
          <div className='dashboard_info'> 
            ...
            <div className='info'>
              ...
              <p>Plusieurs variations de Lorem Ipsum peuvent &ecirc;tre trouv&eacute;es ici ou l&agrave;, mais la majeure partie d&apos;entre elles a &eacute;t&eacute; alt&eacute;r&eacute;e par l&apos;addition d&apos;humour ou de mots al&eacute;atoires qui ne ressemblent pas une seconde &agrave; du texte standard.</p>
            </div>
            <div className='info'>
            ...
            <div className='info'>
              ...
              <p>Plusieurs variations de Lorem Ipsum peuvent &ecirc;tre trouv&eacute;es ici ou l&agrave;, mais la majeure partie d&apos;entre elles a &eacute;t&eacute; alt&eacute;r&eacute;e par l&apos;addition d&apos;humour.</p>
            </div>
            <div className='info'>
              <label htmlFor="" className='info_label'>Are you open to an in-person visit? If yes, when is a good time to meet?</label>
              <p>Plusieurs variations de Lorem Ipsum peuvent &ecirc;tre trouv&eacute;es ici ou l&agrave;, mais la majeure partie d&apos;entre elles a &eacute;t&eacute; alt&eacute;r&eacute;e par l&apos;addition seconde &agrave; du texte standard.</p>
            </div>
          </div>
          <div className='owner_info'>
            ...
            <div className='hotel_image'> 
              ...
              <ul className='image-grid mt-3'>
                ...
                <li><img src="assets/hotel_one.png" className='img-fluid' alt="" /></li>
                <li><img src="assets/hotel_one.png" className='img-fluid' alt="" /></li>
                <li className='position-relative view_more'>
                  <span>View More</span>
                  <img src="assets/hotel_one.png" className='img-fluid' alt="" />
                </li>
              </ul>
            </div>
          </div>
